...
var P = require("./id.js"), inter = defaults({
    renderers: {}
}, P);
...
inter.renderSpelloutCardinal = function(n) {
    ...
    if (n >= 1e18) return this.renderNumber(n, "#,##0.#");
    if (n >= 1e15) return this.renderSpelloutCardinal(Math.floor(n / 1e15)) + " kuadriliun" + (n === 1e15 ? "" : " " + this.renderSpelloutCardinal(n % 1e15));
    if (n >= 1e12) return this.renderSpelloutCardinal(Math.floor(n / 1e12)) + " triliun" + (n === 1e12 ? "" : " " + this.renderSpelloutCardinal(n % 1e12));
    if (n >= 1e9) return this.renderSpelloutCardinal(Math.floor(n / 1e9)) + " miliar" + (n === 1e9 ? "" : " " + this.renderSpelloutCardinal(n % 1e9));
