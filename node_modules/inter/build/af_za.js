...
var P = require("./af.js"), inter = defaults({
    renderers: {}
}, P);
...
inter.renderSpelloutCardinal = function(n) {
    ...
    if (n >= 21e3) return this.renderSpelloutCardinal(Math.floor(n / 1e4)) + " duisend" + (n === 21e3 ? "" : " " + this.renderSpelloutCardinal(n % 1e4));
    if (n >= 2e3) return this.renderSpelloutCardinal(Math.floor(n / 1e3)) + "­duisend" + (n === 2e3 ? "" : " " + this.renderSpelloutCardinal(n % 1e3));
    if (n >= 1e3) return "duisend" + (n === 1e3 ? "" : " " + this.renderSpelloutCardinal(n % 1e3));
    ...
    if (n >= 90) return (n === 90 ? "" : this.renderSpelloutCardinal(n % 10) + "-en-") + "negentig";
    if (n >= 80) return (n === 80 ? "" : this.renderSpelloutCardinal(n % 10) + "-en-") + "tagtig";
    if (n >= 70) return (n === 70 ? "" : this.renderSpelloutCardinal(n % 10) + "-en-") + "sewentig";
    if (n >= 60) return (n === 60 ? "" : this.renderSpelloutCardinal(n % 10) + "-en-") + "sestig";
    if (n >= 50) return (n === 50 ? "" : this.renderSpelloutCardinal(n % 10) + "-en-") + "vyftig";
    if (n >= 40) return (n === 40 ? "" : this.renderSpelloutCardinal(n % 10) + "-en-") + "veertig";
    if (n >= 30) return (n === 30 ? "" : this.renderSpelloutCardinal(n % 10) + "-en-") + "dertig";
    if (n >= 20) return (n === 20 ? "" : this.renderSpelloutCardinal(n % 10) + "-en-") + "twintig";
    if (n >= 19) return "negentien";
    if (n >= 18) return "agttien";
    if (n >= 17) return "sewentien";
    if (n >= 16) return "sestien";
    if (n >= 15) return "vyftien";
