...
var P = require("./sl.js"), inter = defaults({
    renderers: {}
}, P);
...
inter.renderSpelloutCardinalMasculine = function(n) {
    ...
    if (isFractional && n > 1) return this.renderSpelloutCardinalMasculine(Math.floor(n)) + " vejica " + this.renderSpelloutCardinalMasculine(parseInt(String(n).replace(/\d*\./, ""), 10));
    if (n >= 1e18) return this.renderNumber(n, "#,##0");
    ...
    if (n >= 800) return "osemsto" + (n === 800 ? "" : " " + this.renderSpelloutCardinalMasculine(n % 100));
    if (n >= 700) return "sedemsto" + (n === 700 ? "" : " " + this.renderSpelloutCardinalMasculine(n % 100));
    ...
    if (n >= 400) return "štiristo" + (n === 400 ? "" : " " + this.renderSpelloutCardinalMasculine(n % 100));
    ...
    if (n >= 30) return this.renderSpelloutCardinalMasculine(Math.floor(n / 10)) + "deset" + (n === 30 ? "" : " " + this.renderSpelloutCardinalMasculine(n % 10));
    if (n >= 20) return "dvaset" + (n === 20 ? "" : " " + this.renderSpelloutCardinalMasculine(n % 10));
    if (n >= 19) return "devetnajst";
    if (n >= 18) return "asemnajst";
    if (n >= 17) return "sedemnajst";
    if (n >= 16) return "šestnajst";
    if (n >= 15) return "petnajst";
    if (n >= 14) return "štrinajst";
    if (n >= 13) return "trinajst";
    if (n >= 12) return "dvanajst";
    if (n >= 11) return "enajst";
...
inter.renderSpelloutCardinalFeminine = function(n) {
    ...
    if (isFractional && n > 1) return this.renderSpelloutCardinalFeminine(Math.floor(n)) + " vejica " + this.renderSpelloutCardinalFeminine(parseInt(String(n).replace(/\d*\./, ""), 10));
    if (n >= 1e18) return this.renderNumber(n, "#,##0");
    ...
    if (n >= 800) return "osemsto" + (n === 800 ? "" : " " + this.renderSpelloutCardinalFeminine(n % 100));
    if (n >= 700) return "sedemsto" + (n === 700 ? "" : " " + this.renderSpelloutCardinalFeminine(n % 100));
    ...
    if (n >= 400) return "štiristo" + (n === 400 ? "" : " " + this.renderSpelloutCardinalFeminine(n % 100));
    ...
    if (n >= 30) return this.renderSpelloutCardinalFeminine(Math.floor(n / 10)) + "deset" + (n === 30 ? "" : " " + this.renderSpelloutCardinalFeminine(n % 10));
    if (n >= 20) return "dvaset" + (n === 20 ? "" : " " + this.renderSpelloutCardinalFeminine(n % 10));
